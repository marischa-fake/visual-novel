...
const story = {
  ...
  ending_bribe_accepted: {
    ...
    speaker: "",
    text: "Сержант сует кошелёк в карман формы. «Забирай телефон. И проваливайте. Вас тут нет и не было. Нас — тоже.» Алекс разворачивается и уходит. Не оглядываясь.",
    bgm: "bgm-calm",
    isEnding: true,
    endingType: "good",
  ...
  ending_station_evidence: {
    ...
    sceneClass: "bg-station",
    speaker: "",
    text: "Сержант молча достаёт наручники. «Вы задержаны. Вы имеете право хранить молчение...» Алекс понимает — всё. Сержант решил, что Алекс раскладывает предметы, а не собирает.",
    bgm: "bgm-bad",
    isEnding: true,
    endingType: "bad",
